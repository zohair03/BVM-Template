...
export const hero = {
    ...
    btn1Text: "button text goes here",
    href1: "/",
    btn2Text: "button text goes here",
    href2: "/",
    bgImage: "bg-[url('/images/image3.webp')]",
}

export const AboutUsMegaMenuContent = {
...
export const ServicesMegaMenuContent = {
    heading: "Check out all services",
    subtitle: "From laptops and servers to gaming consoles, we provide professional repair, networking, and recycling services.",
...
export const MarqueeText = [
    ...
    `Call us at ${BusinessInfo.PrimaryContactNumber} for support`,
...
export const AboutUsContent = {
    ...
    href: "/",
    image1: "/images/image10.webp",
}

export const WhyChooseUsContent = {
    label: "Why Us",
    heading: "Why Choose Apex Computer Inc",
    description: "Broad Expertise: From Macs and PCs to PlayStation and Xbox consoles, our technicians",
    btnText: "button text goes here",
    href: "/",
...
export const ServicesContent = {
    ...
    subtitle: "From laptops and servers to gaming consoles, we provide professional repair, networking, and recycling services.",
    bgImage: "bg-[url('/images/image1.webp')]",
...
export const FaqsContent = {
    ...
    image: "bg-[url('/images/image5.webp')]",
    bgImage: "bg-[url('/images/image7.webp')]",
    questions: [
        {
            id: 1,
