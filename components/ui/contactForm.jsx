...
const ContactForm = ({ isGlass = false }) => {
  ...
  const inputBaseClasses = isGlass
    ? "glass-input p-3 md:p-4 text-base md:text-lg font-medium outline-none"
    : "border p-3 md:p-4 text-base md:text-lg font-medium placeholder-[#2d3a4a] outline-none transition-all duration-300";
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3 md:gap-4 w-full">
      ...
      <textarea
        ...
        onChange={handleChange}
        rows={5}
        className={`w-full ${getInputErrorClasses("message")}`}
      />
