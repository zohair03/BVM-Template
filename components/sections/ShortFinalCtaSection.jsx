...
const ShortFinalCtaSection = () => {
  return (
    <section className="bg-finalcta-bg flex flex-col xl:flex-row items-center justify-center gap-4 xl:gap-12 px-8 py-8 lg:py-18 lg:px-16 xl:py-6 2xl:px-50">
        ...
        <div className="flex flex-col items-center w-full xl:items-start gap-2">
          ...
          <div className="flex flex-col gap-2 text-center items-center w-fit">
            <div className="flex flex-col items-center xl:items-start gap-1 md:gap-1 lg:gap-0">
              <Label label={FinalCtaContent.label} custom="text-white!"/>
              <H2 text={FinalCtaContent.heading} custom="xl:text-left! text-white" />
            </div>
          </div>
          {/* Content */}
          <div className="flex items-center justify-center gap-3 mb-2 lg:gap-10 xl:gap-16 w-full">
            ...
            <div className="flex flex-col gap-6 w-full items-center xl:items-start">
              <p className="text-white max-[380px]:text-sm text-xl 2xl:text-xl text-center xl:text-left font-sans">
